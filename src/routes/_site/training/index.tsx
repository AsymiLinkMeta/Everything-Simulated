...
function TrainingHub() {
  return (
    <div className="mx-auto w-full min-w-0 max-w-6xl overflow-x-hidden px-4 py-16">
      ...
      <PageIntro
        kicker="Training"
        title="Hours on the platform before hours on the real thing."
        lead="Training is the program layer. The hardware is racing, aircraft or drone. Motorsport and junior driver development already run on four-screen racing crates. Industrial plant, truck, side-kart and excavator work is workshop capacity — enquire, do not expect a shop."
      />
      <div className="mt-10">
        <ToolCards
          links={[
